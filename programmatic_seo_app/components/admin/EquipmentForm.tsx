...
import { addEquipment, editEquipment } from "@/lib/admin-equipment-actions";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (initialData) {
        ...
        result = await editEquipment(initialData.id, formData);
      } else {
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          <div className="row g-4">
            ...
            <div className="col-md-8">
              <div className="mb-4">
                <label className="form-label fw-semibold text-secondary">Equipment Title</label>
                <input 
                  type="text" 
                  name="title" 
                  ...
                  required 
                  placeholder="e.g. Hospital Bed 5 Function"
                />
              </div>

              <div className="mb-4">
                <label className="form-label fw-semibold text-secondary">Price Info</label>
                <input 
                  type="text" 
                  name="price" 
            ...
            <div className="col-md-4">
              <div className="mb-4">
                <label className="form-label fw-semibold text-secondary">Equipment Image</label>
                <div 
              ...
              <div className="d-grid gap-2">
                <button type="submit" className="btn btn-primary btn-lg fw-semibold" disabled={isSubmitting}>
                  {isSubmitting ? (
                    ...
                    <><i className="fa-solid fa-save me-2"></i> {initialData ? 'Update Equipment' : 'Save Equipment'}</>
                  )}
                </button>
